...
class Event(Gtk.ScrolledWindow):
    def __init__(self, app):
        ...
        box.pack_start(Widgets.Label(_('Event Name:')), False, False, 0)

        self.name_entry = Gtk.Entry()
        self.name_entry.connect('changed', self.on_changed)
        box.pack_start(self.name_entry, False, False, 0)

        box.pack_start(Widgets.Label(_('Start Date & Time:')),
                False, False, 0)
        ...
        box.pack_start(Widgets.Label(_('Stop Date & Time:')),
                False, False, 0)
        ...
        box.pack_start(Widgets.Label(_('Event Location:')), False, False, 0)
